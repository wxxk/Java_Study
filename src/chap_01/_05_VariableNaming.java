...
public class _05_VariableNaming {
    public static void main(String[] args) {
        ...
        // 5. 소문자로 시작, 두 단어 이상인 경우 각 단어의 시작글자는 대문자로 (첫 단어는 제외)
        // 6. 예약어는 사용 불가(public, static,  void, int, double, float, ...)

        // 입국 신고서 (여행)
        String nationality = "대한민국";    // 국적
        String firstName = "상욱";    // 이름
        String lastName = "이";  // 성
        String dateOfBirth = "1996-11-23";  // 생년월일
...
//        String -flightNo = "KE6557";    // 하이픈 불가능
